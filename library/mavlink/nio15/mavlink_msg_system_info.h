...
typedef struct __mavlink_system_info_t
{
 ...
 uint32_t usage_time; ///< Thread running time in systime
 uint32_t system_time; ///< System running time in systime
 uint32_t thread_count; ///< Number of running threads
} mavlink_system_info_t;

#define MAVLINK_MSG_ID_SYSTEM_INFO_LEN 16
#define MAVLINK_MSG_ID_155_LEN 16

#define MAVLINK_MSG_ID_SYSTEM_INFO_CRC 32
#define MAVLINK_MSG_ID_155_CRC 32
...
#define MAVLINK_MESSAGE_INFO_SYSTEM_INFO { \
	...
	{  { "cpu_usage", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_system_info_t, cpu_usage) }, \
         { "usage_time", NULL, MAVLINK_TYPE_UINT32_T, 0, 4, offsetof(mavlink_system_info_t, usage_time) }, \
         { "system_time", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_system_info_t, system_time) }, \
         { "thread_count", NULL, MAVLINK_TYPE_UINT32_T, 0, 12, offsetof(mavlink_system_info_t, thread_count) }, \
         } \
}
 ...
 * @param usage_time Thread running time in systime
 * @param system_time System running time in systime
...
static inline uint16_t mavlink_msg_system_info_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       float cpu_usage, uint32_t usage_time, uint32_t system_time, uint32_t thread_count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SYSTEM_INFO_LEN];
	_mav_put_float(buf, 0, cpu_usage);
	_mav_put_uint32_t(buf, 4, usage_time);
	_mav_put_uint32_t(buf, 8, system_time);
	_mav_put_uint32_t(buf, 12, thread_count);
...
{
	return mavlink_msg_system_info_pack(system_id, component_id, msg, system_info->cpu_usage, system_info->usage_time, system_info->system_time, system_info->thread_count);
}
...
{
	return mavlink_msg_system_info_pack_chan(system_id, component_id, chan, msg, system_info->cpu_usage, system_info->usage_time, system_info->system_time, system_info->thread_count);
}
...
static inline void mavlink_msg_system_info_send(mavlink_channel_t chan, float cpu_usage, uint32_t usage_time, uint32_t system_time, uint32_t thread_count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SYSTEM_INFO_LEN];
	_mav_put_float(buf, 0, cpu_usage);
 ...
 */
static inline void mavlink_msg_system_info_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float cpu_usage, uint32_t usage_time, uint32_t system_time, uint32_t thread_count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field usage_time from system_info message
 *
 * @return Thread running time in systime
 */
static inline uint32_t mavlink_msg_system_info_get_usage_time(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint32_t(msg,  4);
}

/**
 * @brief Get field system_time from system_info message
 *
 * @return System running time in systime
 */
static inline uint32_t mavlink_msg_system_info_get_system_time(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_system_info_decode(const mavlink_message_t* msg, mavlink_system_info_t* system_info)
{
	...
	system_info->usage_time = mavlink_msg_system_info_get_usage_time(msg);
	system_info->system_time = mavlink_msg_system_info_get_system_time(msg);
