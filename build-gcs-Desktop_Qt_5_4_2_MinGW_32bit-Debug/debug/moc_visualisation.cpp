...
#include "../../gcs/ui/include/visualisation.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Visualisation_t, stringdata) + ofs \
...
const QMetaObject Visualisation::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_Visualisation.data,
...
void *Visualisation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Visualisation.stringdata))
        return static_cast<void*>(const_cast< Visualisation*>(this));
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< Visualisation*>(this));
